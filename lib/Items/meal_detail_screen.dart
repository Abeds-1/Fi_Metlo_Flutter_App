...
class MealDetailScreen extends StatefulWidget {
  ...
  final darkMode;
  MealDetailScreen(this.toggleFavorite, this.checkIfFavorite, this.darkMode);
                ...
                Positioned(
                  ...
                  child: Container(
                    child: Column(children: <Widget>[
                      ...
                      Container(
                        padding: EdgeInsets.only(bottom: 3, right: 90),
                        child: Text(
                          "This will be the item descrption",
                          style: TextStyle(
                              fontFamily: "POPPINS",
                      ...
                      Container(
                        ...
                        child: Text(
                          "-Rating this item will help users identify which items serve as better alternatives than other items. Put your rating based on quality and brand fidelity to the original product",
                          style: TextStyle(
                              fontFamily: "POPPINS",
                              fontWeight: FontWeight.w300),
                        ),
